...
### PTB-XL
PTB-XL is a "large publicly available electrocardiography dataset" (Wagner et al., 2022). The database is hosted and maintaned on PhysioNet (Goldberg et al., 2000).
