...
def make_moirai_embeddings(SPLIT):
    ...
    SEQ_LEN = 12000  # 16 * 750 Patches
    INPUT_PATH = "data/processed/ptb-xl/ptb-xl-X-" + SPLIT + ".parquet"
    OUTPUT_DIR = "data/embeddings/ptb-xl/"
    FILE_NAME = "MOIRAI-ptb-xl-" + SPLIT + ".parquet"
    ...
    for i in tqdm(range(0, len(X_arr), BATCH_SIZE)):
        ...
        # Go From [Batch, 750, 384] -> [Batch, 384]
